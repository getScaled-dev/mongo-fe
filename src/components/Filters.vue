        ...
        <v-row class="mt-4">
          ...
          <v-col md="3" class="d-flex">
            ...
            <v-menu v-if="filters.dob != 'all'" ref="menu" v-model="menu" :close-on-content-click="false"
              ...
              <v-date-picker v-model="filters.dobStartValue" type="year" :active-picker.sync="activePicker" :max="new Date(Date.now() - new Date().getTimezoneOffset() * 60000)
                .toISOString()
                .substr(0, 10)
            ...
            <v-menu v-if="filters.dob == 'between'" ref="menu1" v-model="menu1" :close-on-content-click="false"
              ...
              <v-date-picker v-model="filters.dobEndValue" type="year" :active-picker.sync="activePicker" :max="new Date(Date.now() - new Date().getTimezoneOffset() * 60000)
                .toISOString()
                .substr(0, 10)
                " min="1900-01-01" @change="save"></v-date-picker>
            </v-menu>
